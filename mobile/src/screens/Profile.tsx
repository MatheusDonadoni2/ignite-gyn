...
const profileSchema = yup.object({
  ...
  password: yup
    .string()
    .min(6, "A senha deve ser pelo menos 6 dígitos.")
    .nullable()
...
export function Profile() {
    ...
    try {
      ...
      if (photoSelected.assets[0].uri) {
        ...
        if (photoInfo?.size && photoInfo.size / 1024 / 1024 > 5) {
          return toast.show({
            title: "Essa imagem é muito grande. Escolha uma menor",
            placement: "top",
            bgColor: "red.500",
          });
        }
  ...
  async function handleProfileUpdate(data: FormDataProps) {
    try {
      ...
      const title = isAppError ? error.message : "Não foi atualizar os dados.";
